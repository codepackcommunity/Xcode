...
import { 
  ...
  Timestamp, startOfDay, endOfDay, startOfMonth, endOfMonth
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div>
                  ...
                  <div className="flex space-x-2">
                    ...
                    <button
                      onClick={() => generateLocationExcelReport(selectedLocation === 'all' ? 'All_Locations' : selectedLocation)}
                      disabled={isGeneratingReport}
            ...
            <div className="bg-gray-800/50 backdrop-blur-sm rounded-xl p-6 border border-gray-700 mb-8">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div>
                  ...
                  <div className="flex space-x-2">
                    <button
                      onClick={() => generateSalesReportByLocation(salesLocationFilter === 'all' ? 'All_Locations' : salesLocationFilter)}
                      disabled={isGeneratingReport}
                    ...
                    <button
                      onClick={() => generateLocationExcelReport(salesLocationFilter === 'all' ? 'All_Locations' : salesLocationFilter)}
                      disabled={isGeneratingReport}
                      className="flex-1 bg-green-600 hover:bg-green-700 disabled:bg-green-400 px-4 py-3 rounded-lg transition-colors flex items-center justify-center space-x-2"
                    >
                      <FaFileExcel />
          ...
          <div className="bg-gray-800/50 backdrop-blur-sm rounded-xl p-6 border border-gray-700">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="bg-gray-800/50 rounded-lg p-5">
                ...
                <div className="space-y-3">
                  {['All Locations Stock Report', 'Low Stock Alert Report', 'Category Analysis Report', 'Supplier Analysis Report'].map((report, index) => (
                    <button
                      key={index}
                      onClick={() => {
                        if (report === 'All Locations Stock Report') generateAllLocationsPDF();
                      }}
                      disabled={isGeneratingReport}
              ...
              <div className="bg-gray-800/50 rounded-lg p-5">
                ...
                <div className="space-y-3">
                  {['Daily Sales Report', 'Monthly Sales Report', 'Location Sales Comparison', 'Customer Sales Analysis'].map((report, index) => (
                    <button
                      key={index}
                      onClick={() => {
                        if (report === 'Daily Sales Report') setSalesTimeFilter('today');
                        if (report === 'Monthly Sales Report') setSalesTimeFilter('month');
                      }}
                      disabled={isGeneratingReport}
                      className="w-full bg-gray-700 hover:bg-gray-600 disabled:bg-gray-800 px-4 py-3 rounded-lg transition-colors flex items-center justify-between"
                    >
